...
Accuracy_percentages = test.check_good()
...
Percentage_dictionary = {
    ...
    'df_phishing': {"dic":dic_df_phishing , "target_column" : "Label" , "dic_detiels_target":dic_detiels_target , "Accuracy percentages" : Accuracy_percentages}
}
